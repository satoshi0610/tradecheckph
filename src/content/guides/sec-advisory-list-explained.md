---
title: "SEC Advisory List Explained: What It Means When a Broker Is Flagged"
description: "An SEC advisory isn't automatically proof of a scam broker — here's what the advisory list actually means, and why even internationally regulated brand names sometimes appear on it."
category: "Regulation & Legality"
lastVerified: 2026-07-25
sources:
  - label: "SEC Philippines — Advisories"
    url: "https://www.sec.gov.ph/investors-education-and-information/advisories/"
draft: false
---
...
- An advisory is a warning to investigate further, not automatically a verdict on the entity's legitimate regulated business (if it has one).
- Always read the specific advisory, not just a headline or a third-party summary.
- Check the SEC's advisory list *and* the broker's claimed offshore regulator's register — separately, and directly on the official sites.
