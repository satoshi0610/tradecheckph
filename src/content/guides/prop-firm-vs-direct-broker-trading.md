---
title: "Prop Firm vs Direct Broker Trading: Which Is Right for Beginners?"
description: "Two different paths to trading, with different capital requirements, different rules, and different risks — here's how to think about which fits your situation."
category: "Prop Firms"
...
- **You bear 100% of any loss**, limited to your deposit (and only limited to that if negative balance protection applies — see our [explainer](/guides/negative-balance-protection-explained/)).
...
You pay an evaluation fee, trade under defined rules, and if you pass, trade the firm's capital under a profit split. See our [what is a prop firm guide](/guides/what-is-a-prop-firm/) for the full mechanics. This means:
